...
__sco.config = {
  ...
  'guid': '8c6b63c5-5caf-43c0-9337-3d2ecf42069a', // V2 guid
  'v1guid': '8c6b63c5-5caf-43c0-9337-3d2ecf42069a', // V1 guid, the api key for the client

  'triggers': ['exit', 'timeout'], // Set the triggers to use, use either load or exit and timeout together

  'status1': [function () { return __sco.statusEval().statusOne; }], // Strings to be set in lower case, will be compared against the URL of the current page. Functions will be executed and must return either true, false or a number to use as the status
  'status2': ["STATUSTWO"],
  'status3': [function () { return __sco.statusEval().statusThree; }],
  'status4': ["STATUSFOUR"],
...
__sco.statusEval = function() {
  var config = [
    {
      match: /_implementing/i,
      statusOne: true,
      statusThree: false,
      statusFour: true,
      osrPage: true,
  ...
  for (var i = 0; i < config.length; i++) {
    if (config[i].match instanceof RegExp) {
      if (config[i].match.test(location.href) === true)
        return config[i];
    }
  }
  return {
...
try {
  ...
  __sco.osr.clientConfigModule = function () {
    ...
    __sco.osr.clientIp = '209.194.236.206';
    __sco.osr.retrieveClientIp = () => {};

    // setTimeout(() => document.dispatchEvent( new MouseEvent('mouseout', {clientX: 9999}) ), 1000);

    meld.around(__sco.osr, 'preShowChecks', (m) => true);

    meld.after(__sco.osr, 'osrInitComplete', () => {
      __sco.osr.activePageConfig.useStandardSelectors = false;
    ...
    meld.around(__sco.osr, 'getTemplateById', (m) => {
      let arg = m.args[0];
      let res = m.proceed();
      if (arg === 4064)
        return Object.assign({}, res, {
          html: `<div data-osr-id="1">
            <h1>litebox 1</h1>
            <button class="cta-sc">litebox cta</button>
          </div>`,
          stylesheet: `
            [data-osr-id="1"]
          `
        ...
        return Object.assign({}, res, {
          html: `<div data-osr-id="2">
            <h1>sticky osr trends are 10</h1>
            <div data-trends-show-sc="2">lfkd</div>
            <button class="cta-sc">trends cta</button>
          </div>`,
          stylesheet: `
            [data-osr-id="2"] {
              position: fixed;
    ...
    meld.after(__sco.osr, 'preRender', () => {
      var id = __sco.osr.activePageConfig.pageInstances.reduce((acc, i) => {
        return i.instanceName === 'trends sticky' ? i.filters[0].templates.osr : acc;
      }, null);
      var tmpl = __sco.osr.getTemplateById(id);
      var style = _scs('style.sc-lb:last');
      style.innerHTML += tmpl.stylesheet;
      console.log(style)
      var container = document.createElement('div');
      container.innerHTML = tmpl.html;
      var el = _scs([container, '*:first']);
      _scs('body')[0].appendChild(el);
    });
  ...
  __sco.osr.renderOverlay = function () {
    ...
    overlayContainerEl.setAttribute('data-sc-link-id', 'Background');
  ...
  __sco.osr.addEvents = function (instanceConfigObj) {
    ...
    function attachInactivity(ev) {
      ...
      ev.clientX = ev.clientX || (__sco.noru(ev.changedTouches) && ev.changedTouches.length > 0 ? ev.changedTouches[0].clientX : null);
      ev.clientY = ev.clientY || (__sco.noru(ev.changedTouches) && ev.changedTouches.length > 0 ? ev.changedTouches[0].clientY : null);
...
Array.prototype.filter||(Array.prototype.filter=function(a){"use strict";if(void 0===this||null===this)throw new TypeError;var b=Object(this),c=b.length>>>0;if("function"!=typeof a)throw new TypeError;for(var d=[],e=arguments.length>=2?arguments[1]:void 0,f=0;f<c;f++)if(f in b){var g=b[f];a.call(e,g,f,b)&&d.push(g)}return d}),Array.prototype.reduce||(Array.prototype.reduce=function(a){"use strict";if(null==this)throw new TypeError("Array.prototype.reduce called on null or undefined");if("function"!=typeof a)throw new TypeError(a+" is not a function");var e,b=Object(this),c=b.length>>>0,d=0;if(2==arguments.length)e=arguments[1];else{for(;d<c&&!(d in b);)d++;if(d>=c)throw new TypeError("Reduce of empty array with no initial value");e=b[d++]}for(;d<c;d++)d in b&&(e=a(e,b[d],d,b));return e}),Array.prototype.map||(Array.prototype.map=function(a,b){var c,d,e;if(null==this)throw new TypeError(" this is null or not defined");var f=Object(this),g=f.length>>>0;if("function"!=typeof a)throw new TypeError(a+" is not a function");for(arguments.length>1&&(c=b),d=new Array(g),e=0;e<g;){var h,i;e in f&&(h=f[e],i=a.call(c,h,e,f),d[e]=i),e++}return d});
...
Array.prototype.reduce||(Array.prototype.reduce=function(a){"use strict";if(null==this)throw new TypeError("Array.prototype.reduce called on null or undefined");if("function"!=typeof a)throw new TypeError(a+" is not a function");var e,b=Object(this),c=b.length>>>0,d=0;if(2==arguments.length)e=arguments[1];else{for(;d<c&&!(d in b);)d++;if(d>=c)throw new TypeError("Reduce of empty array with no initial value");e=b[d++]}for(;d<c;d++)d in b&&(e=a(e,b[d],d,b));return e});